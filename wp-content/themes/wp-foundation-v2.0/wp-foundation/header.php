...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<title>Turkish Accelerator and Radiation Laboratory at Ankara</title>
	...
	<body <?php body_class(); ?>>
		...
		<div class="row container">
			<div class="twelve columns">
				...
				<div class="logo">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="/wp-content/uploads/2014/06/logo2.png" width="" height="" alt="" /></a>
				</div>

				<div class="siteinfo">
						<h1><a href="<?php echo get_bloginfo('url'); ?>">Turkish Accelerator and Radiation<center>Laboratory in Ankara</center></a></h1>
						<h5 class="subhead" style="padding-left: 840px; text-decoration: underline;"><?php echo get_bloginfo ( 'description' ); ?></h5>
					</div>
